...
func SelectGroup(id string) (models.Group, *errors.SensError) {
	db := models.GetConnection()
	m := models.Group{}
...
func FindGroup(or []string, and []string, span []string, limit string, column string, order string) ([]models.Group, *errors.SensError) {
