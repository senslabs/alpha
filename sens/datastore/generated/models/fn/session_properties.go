...
func buildSessionPropertieWhereClause(query *bytes.Buffer, or []string, and []string, span []string, values map[string]interface{}) {
...
func FindSessionPropertie(or []string, and []string, span []string, limit string, column string, order string) ([]models.SessionPropertie, *errors.SensError) {
	...
	buildSessionPropertieWhereClause(query, or, and, span, values)
	if column != "" {
...
func UpdateSessionPropertieWhere(or []string, and []string, span []string, data []byte) *errors.SensError {
	...
	buildSessionPropertieWhereClause(update, or, and, span, values)
