...
CREATE TABLE "auths" (
  ...
  "created_at" int DEFAULT date_part('epoch', now()),
  "updated_at" int,
  "is_sens" bool
);
...
CREATE TABLE "survey_answers" (
  "survey_answer_id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE "device_activities" (
  "device_id" uuid,
  "activity_type" text,
  "active_at" int DEFAULT date_part('epoch', now()),
...
CREATE TABLE "session_settings" (
  "session_setting_id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
  "user_id" uuid,
  "key" text,
  "created_at" int,
  "session_type" text,
