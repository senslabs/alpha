...
curl -v -H 'Content-Type: application/json' -d '{"OrgId":"39ed9a7d-ecfe-42e0-a579-2d733064490c", "Key":"DisplayName", "Value":"Leaf Ayurveda"}' http://35.184.200.59/api/org-settings/create
