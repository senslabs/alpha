...
ALTER TABLE "endpoint_groups" ADD FOREIGN KEY ("endpoint_id") REFERENCES "endpoints" ("id");

ALTER TABLE "endpoint_groups" ADD FOREIGN KEY ("group_id") REFERENCES "groups" ("id");
